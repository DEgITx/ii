// V4L2-источник видеокадров для NPU-раннера.
//
// Покрывает типовой сценарий NPU: USB UVC-камера или CSI-сенсор,
// экспортируемый драйвером как /dev/videoN. Используем самый простой
