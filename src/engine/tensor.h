...
//
// Движок `ii` — это backend-нейтральная реализация ii::Engine, написанная
...
//
// Весь счёт внутри `ii` идёт в float32. Квантованные веса конвертируются
...
// мост к ii::Engine живёт отдельно в engine/backend.cpp.
